data modify storage alt:horse health set from entity @s attributes[{id:"minecraft:max_health"}].base
...
execute store result score $jump1 alt.math run data get entity @s attributes[{id:"minecraft:jump_strength"}].base 1000
...
execute store result score $speed alt.math run data get entity @s attributes[{id:"minecraft:movement_speed"}].base 1000
